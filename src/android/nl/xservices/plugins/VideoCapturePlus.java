...
//      value.put(MediaStore.Video.Media.DATA, getTempDirectoryPath());

//      File photo = new File(getTempDirectoryPath(), "EddyVid.mp4");
//      intent.putExtra(android.provider.MediaStore.EXTRA_OUTPUT, Uri.fromFile(photo));

//      Uri videoUri = this.cordova.getActivity().getContentResolver().insert(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, value);
...
// TODO Auto-generated method stub
        ...
        Runnable captureVideo = new Runnable() {
          ...
          public void run() {
            ...
            Uri data = intent.getData();
            data = Uri.parse(getVideoContentUriFromFilePath(cordova.getActivity(), getTempDirectoryPath()));
            // create a file object from the uri
            if(data == null)
            {
